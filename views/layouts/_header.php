                            ...
                            <?php if (!Yii::$app->user->isGuest) { ?>
                                <li>
                                    <a href="<?= Url::to(['/site/logout'])?>"><i class="fa fa-user"></i>
                                        <?= Yii::$app->user->identity['username']?> (Exit)
                                    </a>
                                </li>
                            <? } ?>
                            <li><a href="#"><i class="fa fa-star"></i> Wishlist</a></li>
                            <li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            <li><a href="#" class="js-bucket-show"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                ...
                <div class="col-sm-3">
                    <div class="search_box pull-right">
                        <form action="<?= Url::to(['search-category'])?>" method="get">
                            <input type="text" placeholder="Search" name="queryGet">
                        </form>
                    </div>
                </div>
            </div>
